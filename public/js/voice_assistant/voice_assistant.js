   ...
   let comands = {
       ...
       'привет гидеон||привет':()=>{
           gideon.random_answer([
               {'answer':()=>{
                       ...
                       console.log('Гидеон: Привет, рад тебя видеть!');
       ...
       'как ты||как ты гидеон||как дела||как дела гидеон':() => {
           ...
           gideon.random_answer([
               ...
               {'answer':()=>{
                   console.log('Гидеон:Дела отлично')
       ...
       'я человек':()=>{
           gideon.random_answer([
               {'answer':() => {
                       console.log('Гидеон:А я робот')
                       gideon.say('А я робот')
               }},
               {'answer':()=>{
                   console.log('Гидеон:рада за тебя')
       ...
       'что делаешь':()=>{
           gideon.random_answer([
               {'answer':() => {
                   console.log('Гидеон:Учусь новому у тебя')
